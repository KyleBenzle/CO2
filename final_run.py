"""
FINAL ANALYSIS - CO2 levels in N95 masks with latest corrected data.
This script performs the full statistical analysis and generates the final figures.
"""
...
plt.bar(x, means.values, yerr=std_errs.values, capsize=10, 
        color=['#396AB1', '#DA7C30', '#3E9651'], width=0.6, edgecolor='black', linewidth=1.5)
...
# Customize the plot
plt.title('CO2 Concentrations by Measurement Phase', fontweight='bold')
plt.ylabel('CO2 Concentration (ppm)', fontweight='bold')
plt.xticks(x, means.index)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig(output_dir + "/figure1_co2_by_type.png", dpi=300, bbox_inches='tight')
plt.savefig(output_dir + "/figure1_co2_by_type.pdf", bbox_inches='tight')
plt.close()
...
plt.title('Distribution of CO2 Concentrations', fontweight='bold')
plt.ylabel('CO2 Concentration (ppm)', fontweight='bold')
plt.xlabel('Measurement Phase', fontweight='bold')
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig(output_dir + "/figure2_co2_distribution.png", dpi=300, bbox_inches='tight')
plt.savefig(output_dir + "/figure2_co2_distribution.pdf", bbox_inches='tight')
plt.close()
...
plt.bar(r1, means['Single Mask'], width=barwidth, edgecolor='black', linewidth=1.5,
        yerr=errors['Single Mask'], capsize=7, label='Single Mask', color='#396AB1')
plt.bar(r2, means['Double Mask'], width=barwidth, edgecolor='black', linewidth=1.5,
        yerr=errors['Double Mask'], capsize=7, label='Double Mask', color='#DA7C30')
...
# Customize plot
plt.title('CO2 Concentrations: Single vs Double Mask', fontweight='bold')
plt.ylabel('CO2 Concentration (ppm)', fontweight='bold')
plt.xlabel('Measurement Phase', fontweight='bold')
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig(output_dir + "/figure3_mask_comparison.png", dpi=300, bbox_inches='tight')
plt.savefig(output_dir + "/figure3_mask_comparison.pdf", bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(output_dir + "/figure4_correlation.png", dpi=300, bbox_inches='tight')
plt.savefig(output_dir + "/figure4_correlation.pdf", bbox_inches='tight')
plt.close()
